declare module '@pkistudio/dereditor/core' {
  ...
  export type DerEditorCoreApi = {
    ...
    getTagName: (node: DerEditorParsedNode) => string;
    describeValue: (node: DerEditorParsedNode) => string;
    ...
    resolveOid: (oid: string, resolver?: DerEditorOidResolver) => string;
  };
